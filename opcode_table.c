...
const struct opcode_def opcode_table[] = {
    ...
    /* 0x13 */ { "SYNC",         OP_SYNC,         4,  REG_NONE, INHERENT,  sync     },
    /* 0x14 */ { "NOTIMPL",      0x14,            2,  REG_NONE, INHERENT,  notimpl  },
    /* 0x15 */ { "NOTIMPL",      0x15,            2,  REG_NONE, INHERENT,  notimpl  },
    /* 0x16 */ { "LBRA",         OP_LBRA,         5,  REG_NONE, LONG_BRANCH,  branch16 },
    /* 0x17 */ { "LBSR",         OP_LBSR,         9,  REG_NONE, LONG_BRANCH,  branch16 },
    ...
    /* 0x23 */ { "BLS",          OP_BLS,          3,  REG_NONE, SHORT_BRANCH,  branch   },
    /* 0x24 */ { "BCC",          OP_BCC,          3,  REG_NONE, SHORT_BRANCH,  branch   },
    /* 0x25 */ { "BCS",          OP_BCS,          3,  REG_NONE, SHORT_BRANCH,  branch   },
    /* 0x26 */ { "BNE",          OP_BNE,          3,  REG_NONE, SHORT_BRANCH,  branch   },
    /* 0x27 */ { "BEQ",          OP_BEQ,          3,  REG_NONE, SHORT_BRANCH,  branch   },
    /* 0x28 */ { "BVC",          OP_BVC,          3,  REG_NONE, SHORT_BRANCH,  branch   },
    /* 0x29 */ { "BVS",          OP_BVS,          3,  REG_NONE, SHORT_BRANCH,  branch   },
    /* 0x2A */ { "BPL",          OP_BPL,          3,  REG_NONE, SHORT_BRANCH,  branch   },
    /* 0x2B */ { "BMI",          OP_BMI,          3,  REG_NONE, SHORT_BRANCH,  branch   },
    /* 0x2C */ { "BGE",          OP_BGE,          3,  REG_NONE, SHORT_BRANCH,  branch   },
    /* 0x2D */ { "BLT",          OP_BLT,          3,  REG_NONE, SHORT_BRANCH,  branch   },
    /* 0x2E */ { "BGT",          OP_BGT,          3,  REG_NONE, SHORT_BRANCH,  branch   },
    /* 0x2F */ { "BLE",          OP_BLE,          3,  REG_NONE, SHORT_BRANCH,  branch   },
    ...
    /* 0x34 */ { "PSHS",         OP_PSHS,         5,  REG_S,    IMMEDIATE_PUSH, psh      },
    /* 0x35 */ { "PULS",         OP_PULS,         5,  REG_S,    IMMEDIATE_PULL, pul      },
    /* 0x36 */ { "PSHU",         OP_PSHU,         5,  REG_U,    IMMEDIATE_PUSH, psh      },
    /* 0x37 */ { "PULU",         OP_PULU,         5,  REG_U,    IMMEDIATE_PULL, pul      },
    /* 0x38 */ { "NOTIMPL",      0x38,            2,  REG_NONE, INHERENT,  notimpl  },
    /* 0x39 */ { "RTS",          OP_RTS,          5,  REG_NONE, INHERENT,  rts      },
    /* 0x3A */ { "ABX",          OP_ABX,          3,  REG_NONE, INHERENT,  abx      },
    /* 0x3B */ { "RTI",          OP_RTI,          6,  REG_NONE, INHERENT,  rti      },
    ...
    /* 0x8D */ { "BSR",          OP_BSR,          7,  REG_NONE, SHORT_BRANCH,  branch   },
...
const struct opcode_def opcode_ext_x10_table[] = {
    ...
    { "LBRN",    OP_LBRN,   5, REG_NONE, LONG_BRANCH,  branch16 },
    { "LBHI",    OP_LBHI,   5, REG_NONE, LONG_BRANCH,  branch16 },
    { "LBLS",    OP_LBLS,   5, REG_NONE, LONG_BRANCH,  branch16 },
    { "LBCC",    OP_LBCC,   5, REG_NONE, LONG_BRANCH,  branch16 },
    { "LBCS",    OP_LBCS,   5, REG_NONE, LONG_BRANCH,  branch16 },
    { "LBNE",    OP_LBNE,   5, REG_NONE, LONG_BRANCH,  branch16 },
    { "LBEQ",    OP_LBEQ,   5, REG_NONE, LONG_BRANCH,  branch16 },
    { "LBVC",    OP_LBVC,   5, REG_NONE, LONG_BRANCH,  branch16 },
    { "LBVS",    OP_LBVS,   5, REG_NONE, LONG_BRANCH,  branch16 },
    { "LBPL",    OP_LBPL,   5, REG_NONE, LONG_BRANCH,  branch16 },
    { "LBMI",    OP_LBMI,   5, REG_NONE, LONG_BRANCH,  branch16 },
    { "LBGE",    OP_LBGE,   5, REG_NONE, LONG_BRANCH,  branch16 },
    { "LBLT",    OP_LBLT,   5, REG_NONE, LONG_BRANCH,  branch16 },
    { "LBGT",    OP_LBGT,   5, REG_NONE, LONG_BRANCH,  branch16 },
    { "LBLE",    OP_LBLE,   5, REG_NONE, LONG_BRANCH,  branch16 },
    ...
    { "SWI2",    OP_SWI2,   20,REG_NONE, INHERENT,  swi2     },
...
const struct opcode_def opcode_ext_x11_table[] = {
    ...
    { "NOTIMPL", 0x3D,      2, REG_NONE, INHERENT,  notimpl },
    { "NOTIMPL", 0x3E,      2, REG_NONE, INHERENT,  notimpl },
    { "SWI3",    OP_SWI3,   20,REG_NONE, INHERENT,  swi3    },
    { "NOTIMPL", 0x40,      2, REG_NONE, INHERENT,  notimpl },
    { "NOTIMPL", 0x41,      2, REG_NONE, INHERENT,  notimpl },
    { "NOTIMPL", 0x42,      2, REG_NONE, INHERENT,  notimpl },
    { "NOTIMPL", 0x43,      2, REG_NONE, INHERENT,  notimpl },
