...
const struct opcode_def opcode_table[] = {
    ...
    /* 0x16 */ { "LBRA",         OP_LBRA,         5,  REG_NONE, INHERENT,  branch16 },
    /* 0x17 */ { "LBSR",         OP_LBSR,         9,  REG_NONE, INHERENT,  branch16 },
    ...
    /* 0x20 */ { "BRA",          OP_BRA,          3,  REG_NONE, INHERENT,  branch   },
    /* 0x21 */ { "BRN",          OP_BRN,          3,  REG_NONE, INHERENT,  branch   },
    ...
    /* 0x8D */ { "BSR",          OP_BSR,          7,  REG_NONE, INHERENT,  branch   },
...
const struct opcode_def opcode_ext_x10_table[] = {
    ...
    { "LBRN",    OP_LBRN,   5, REG_NONE, INHERENT,  branch16 },
    ...
    { "LBNE",    OP_LBNE,   5, REG_NONE, INHERENT,  branch16 },
    { "LBEQ",    OP_LBEQ,   5, REG_NONE, INHERENT,  branch16 },
    { "LBVC",    OP_LBVC,   5, REG_NONE, INHERENT,  branch16 },
    { "LBVS",    OP_LBVS,   5, REG_NONE, INHERENT,  branch16 },
    { "LBPL",    OP_LBPL,   5, REG_NONE, INHERENT,  branch16 },
    { "LBMI",    OP_LBMI,   5, REG_NONE, INHERENT,  branch16 },
