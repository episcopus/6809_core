...
int main(void) {
    const struct CMUnitTest tests[] = {
        ...
        cmocka_unit_test_setup(inca_test, test_setup),
        cmocka_unit_test_setup(incb_test, test_setup),
        ...
        cmocka_unit_test_setup(mul_test, test_setup),
        cmocka_unit_test_setup(mul_signed_test, test_setup),
        cmocka_unit_test_setup(mul_zero_test, test_setup),
        cmocka_unit_test_setup(nega_test, test_setup),
        cmocka_unit_test_setup(negb_test, test_setup),
        cmocka_unit_test_setup(nega_minusone_test, test_setup),
        cmocka_unit_test_setup(negb_minusone_test, test_setup),
        cmocka_unit_test_setup(rola_test, test_setup),
        cmocka_unit_test_setup(rolb_test, test_setup),
        ...
        cmocka_unit_test_setup(sex_test, test_setup),
        cmocka_unit_test_setup(sex_negative_test, test_setup),
        cmocka_unit_test_setup(sex_zero_test, test_setup),
        cmocka_unit_test_setup(tsta_test, test_setup),
        cmocka_unit_test_setup(tstb_test, test_setup),
        cmocka_unit_test_setup(tsta_negative_test, test_setup),
        cmocka_unit_test_setup(tstb_negative_test, test_setup),
        cmocka_unit_test_setup(tsta_zero_test, test_setup),
        cmocka_unit_test_setup(tstb_zero_test, test_setup)
    };
