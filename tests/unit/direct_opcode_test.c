...
void lsr_direct_test(void **state) {
    ...
    int cycles = run_cycles(opcode_table[OP_LSR_D].cycle_count);
    int post_pc = e_cpu_context.pc;
    assert_int_equal(read_byte_from_memory(S_POINTER + lower_byte_address),
                     0x1);
    assert_int_equal(cycles, opcode_table[OP_LSR_D].cycle_count);
    assert_int_equal(post_pc, pre_pc + 2);
}
...
void std_direct_test(void **state) {
    ...
    int cycles = run_cycles(opcode_table[OP_STD_D].cycle_count);
    int post_pc = e_cpu_context.pc;
    assert_int_equal(get_reg_value_16(REG_D), 0x1969);
    assert_int_equal(read_word_from_memory(S_POINTER + lower_byte_address),
                     0x1969);
    assert_int_equal(cycles, opcode_table[OP_STD_D].cycle_count);
    assert_int_equal(post_pc, pre_pc + 2);
}
...
void sts_direct_test(void **state) {
    ...
    int cycles = run_cycles(opcode_ext_x10_table[OP_STS_D].cycle_count);
    int post_pc = e_cpu_context.pc;
    assert_int_equal(get_reg_value_16(REG_S), 0x1969);
    assert_int_equal(read_word_from_memory(S_POINTER + lower_byte_address),
                     0x1969);
    assert_int_equal(cycles, opcode_ext_x10_table[OP_STS_D].cycle_count);
...
void stu_direct_test(void **state) {
    ...
    int cycles = run_cycles(opcode_table[OP_STU_D].cycle_count);
    int post_pc = e_cpu_context.pc;
    assert_int_equal(get_reg_value_16(REG_U), 0x1969);
    assert_int_equal(read_word_from_memory(S_POINTER + lower_byte_address),
                     0x1969);
    assert_int_equal(cycles, opcode_table[OP_STU_D].cycle_count);
    assert_int_equal(post_pc, pre_pc + 2);
}
...
void stx_direct_test(void **state) {
    ...
    int cycles = run_cycles(opcode_table[OP_STX_D].cycle_count);
    int post_pc = e_cpu_context.pc;
    assert_int_equal(get_reg_value_16(REG_X), 0x1969);
    assert_int_equal(read_word_from_memory(S_POINTER + lower_byte_address),
                     0x1969);
    assert_int_equal(cycles, opcode_table[OP_STX_D].cycle_count);
    assert_int_equal(post_pc, pre_pc + 2);
}
...
void sty_direct_test(void **state) {
    ...
    int cycles = run_cycles(opcode_ext_x10_table[OP_STY_D].cycle_count);
    int post_pc = e_cpu_context.pc;
    assert_int_equal(get_reg_value_16(REG_Y), 0x1969);
    assert_int_equal(read_word_from_memory(S_POINTER + lower_byte_address),
                     0x1969);
    assert_int_equal(cycles, opcode_ext_x10_table[OP_STY_D].cycle_count);
    assert_int_equal(post_pc, pre_pc + 3);
}
...
void suba_direct_test(void **state) {
    ...
    int cycles = run_cycles(opcode_table[OP_SUBA_D].cycle_count);
    int post_pc = e_cpu_context.pc;
    ...
    assert_int_equal(e_cpu_context.cc.z, 0);
    assert_int_equal(e_cpu_context.cc.v, 0);
    assert_int_equal(cycles, opcode_table[OP_SUBA_D].cycle_count);
    assert_true(post_pc == pre_pc + 2);
}
...
void subb_direct_test(void **state) {
    ...
    int cycles = run_cycles(opcode_table[OP_SUBB_D].cycle_count);
    int post_pc = e_cpu_context.pc;
    ...
    assert_int_equal(e_cpu_context.cc.z, 0);
    assert_int_equal(e_cpu_context.cc.v, 0);
    assert_int_equal(cycles, opcode_table[OP_SUBB_D].cycle_count);
    assert_true(post_pc == pre_pc + 2);
}
...
void subd_direct_test(void **state) {
    ...
    int cycles = run_cycles(opcode_table[OP_SUBD_D].cycle_count);
    int post_pc = e_cpu_context.pc;
    ...
    assert_int_equal(e_cpu_context.cc.z, 0);
    assert_int_equal(e_cpu_context.cc.v, 0);
    assert_int_equal(cycles, opcode_table[OP_SUBD_D].cycle_count);
    assert_true(post_pc == pre_pc + 2);
}
...
void tst_direct_test(void **state) {
    ...
    int cycles = run_cycles(opcode_table[OP_TST_D].cycle_count);
    int post_pc = e_cpu_context.pc;

    assert_int_equal(cycles, opcode_table[OP_TST_D].cycle_count);
    assert_int_equal(e_cpu_context.cc.n, 0);
    assert_int_equal(e_cpu_context.cc.z, 1);
    assert_int_equal(e_cpu_context.cc.v, 0);
    assert_int_equal(post_pc, pre_pc + 2);
