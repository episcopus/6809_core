...
void cmpx_indexed_no_overflow_test(void **state) {
    (void) state; /* unused */
    int pre_pc = e_cpu_context.pc;
...
void ldb_indexed_test(void **state) {
    ...
    assert_int_equal(cycles, opcode_table[OP_LDB_I].cycle_count + 1);
    assert_int_equal(post_pc, pre_pc + 3);
}
...
void ldd_indexed_test(void **state) {
    ...
    assert_int_equal(cycles, opcode_table[OP_LDD_I].cycle_count + 1);
    assert_true(post_pc == pre_pc + 3);
}
...
void lds_indexed_test(void **state) {
    ...
    assert_int_equal(cycles, opcode_ext_x10_table[OP_LDS_I].cycle_count + 1);
...
void ldu_indexed_test(void **state) {
    ...
    assert_int_equal(cycles, opcode_table[OP_LDU_I].cycle_count + 1);
    assert_true(post_pc == pre_pc + 3);
}
...
void leas_indexed_test(void **state) {
    ...
    int cycles = run_cycles(opcode_table[OP_LEAS_I].cycle_count);
    int post_pc = e_cpu_context.pc;

    assert_int_equal(cycles, opcode_table[OP_LEAS_I].cycle_count + 1);
    assert_int_equal(get_reg_value_16(REG_S), USER_SPACE_ROOT + 3 + lower_byte_offset);
    assert_int_equal(post_pc, pre_pc + 3);
}
...
void leau_indexed_test(void **state) {
    ...
    int cycles = run_cycles(opcode_table[OP_LEAU_I].cycle_count);
    int post_pc = e_cpu_context.pc;

    assert_int_equal(cycles, opcode_table[OP_LEAU_I].cycle_count + 1);
    assert_int_equal(get_reg_value_16(REG_U), USER_SPACE_ROOT + 3 + lower_byte_offset);
    assert_int_equal(post_pc, pre_pc + 3);
}
...
void leax_indexed_test(void **state) {
    ...
    int cycles = run_cycles(opcode_table[OP_LEAX_I].cycle_count);
    int post_pc = e_cpu_context.pc;

    assert_int_equal(cycles, opcode_table[OP_LEAX_I].cycle_count + 1);
    assert_int_equal(get_reg_value_16(REG_X), USER_SPACE_ROOT + 3 + lower_byte_offset);
    assert_int_equal(post_pc, pre_pc + 3);
}
...
void leay_indexed_test(void **state) {
    ...
    int cycles = run_cycles(opcode_table[OP_LEAY_I].cycle_count);
    int post_pc = e_cpu_context.pc;

    assert_int_equal(cycles, opcode_table[OP_LEAY_I].cycle_count + 1);
    assert_int_equal(get_reg_value_16(REG_Y), USER_SPACE_ROOT + 3 + lower_byte_offset);
    assert_int_equal(post_pc, pre_pc + 3);
}
...
void lsr_indexed_test(void **state) {
    ...
    /* b shouldn't be messed with */
    e_cpu_context.d.byte_acc.b = 8;
    int cycles = run_cycles(opcode_table[OP_LSR_I].cycle_count);
    int post_pc = e_cpu_context.pc;

    assert_int_equal(cycles, opcode_table[OP_LSR_I].cycle_count + 1);
    assert_int_equal(read_byte_from_memory(USER_SPACE_ROOT + 3 + lower_byte_offset),
                     0x1);
    assert_int_equal(e_cpu_context.d.byte_acc.b, 0x8);
    assert_int_equal(e_cpu_context.cc.c, 0);
...
void neg_indexed_test(void **state) {
    ...
    assert_int_equal(cycles, opcode_table[OP_NEG_I].cycle_count + 1);
    assert_int_equal(read_byte_from_memory(USER_SPACE_ROOT + 3 + lower_byte_offset),
                     0xFF);
    assert_int_equal(e_cpu_context.cc.c, 1);
    assert_int_equal(e_cpu_context.cc.v, 0);
...
void ora_indexed_test(void **state) {
    ...
    assert_int_equal(e_cpu_context.cc.z, 0);
    assert_int_equal(e_cpu_context.cc.v, 0);
    assert_int_equal(cycles, opcode_table[OP_ORA_I].cycle_count + 1);
    assert_true(post_pc == pre_pc + 3);
}
...
void orb_indexed_test(void **state) {
    ...
    assert_int_equal(e_cpu_context.cc.z, 0);
    assert_int_equal(e_cpu_context.cc.v, 0);
    assert_int_equal(cycles, opcode_table[OP_ORB_I].cycle_count + 1);
    assert_true(post_pc == pre_pc + 3);
}
...
void rol_indexed_test(void **state) {
    ...
    assert_int_equal(cycles, opcode_table[OP_ROL_I].cycle_count + 1);
    assert_int_equal(read_byte_from_memory(USER_SPACE_ROOT + 3 + lower_byte_offset),
                     0x4);
    assert_int_equal(e_cpu_context.cc.c, 0);
    assert_int_equal(e_cpu_context.cc.n, 0);
...
void ror_indexed_test(void **state) {
    ...
    assert_int_equal(cycles, opcode_table[OP_ROR_I].cycle_count + 1);
    assert_int_equal(read_byte_from_memory(USER_SPACE_ROOT + 3 + lower_byte_offset),
                     0x1);
    assert_int_equal(e_cpu_context.cc.c, 0);
    assert_int_equal(e_cpu_context.cc.n, 0);
...
void sbca_indexed_test(void **state) {
    ...
    assert_int_equal(e_cpu_context.cc.z, 0);
    assert_int_equal(e_cpu_context.cc.v, 0);
    assert_int_equal(cycles, opcode_table[OP_SBCA_I].cycle_count + 1);
    assert_true(post_pc == pre_pc + 3);
}
...
void sbcb_indexed_test(void **state) {
    ...
    assert_int_equal(e_cpu_context.cc.z, 0);
    assert_int_equal(e_cpu_context.cc.v, 0);
    assert_int_equal(cycles, opcode_table[OP_SBCB_I].cycle_count + 1);
    assert_true(post_pc == pre_pc + 3);
}
...
void sta_indexed_test(void **state) {
    ...
    assert_int_equal(read_byte_from_memory(USER_SPACE_ROOT + 3 + lower_byte_offset),
                     0x69);
    assert_int_equal(cycles, opcode_table[OP_STA_I].cycle_count + 1);
    assert_int_equal(post_pc, pre_pc + 3);
}
...
void stb_indexed_test(void **state) {
    ...
    assert_int_equal(read_byte_from_memory(USER_SPACE_ROOT + 3 + lower_byte_offset),
                     0x69);
    assert_int_equal(cycles, opcode_table[OP_STB_I].cycle_count + 1);
    assert_int_equal(post_pc, pre_pc + 3);
}
...
void std_indexed_test(void **state) {
    ...
    uint8 lower_byte_offset = 0x40;
    assert_int_equal(read_word_from_memory(USER_SPACE_ROOT + 3 + lower_byte_offset),
                     0);
    uint8 code_bytes[] = {
        OP_STD_I,
        0x8C, /* Constant 8-bit offset from PC */
    ...
    assert_int_equal(read_word_from_memory(USER_SPACE_ROOT + 3 + lower_byte_offset),
                     0x1969);
    assert_int_equal(cycles, opcode_table[OP_STD_I].cycle_count + 1);
    assert_int_equal(post_pc, pre_pc + 3);
}
...
void stu_indexed_test(void **state) {
    ...
    assert_int_equal(read_word_from_memory(USER_SPACE_ROOT + 3 + lower_byte_offset),
                     0x1969);
    assert_int_equal(cycles, opcode_table[OP_STU_I].cycle_count + 1);
    assert_int_equal(post_pc, pre_pc + 3);
}
...
void stx_indexed_test(void **state) {
    ...
    assert_int_equal(read_word_from_memory(USER_SPACE_ROOT + 3 + lower_byte_offset),
                     0x1969);
    assert_int_equal(cycles, opcode_table[OP_STX_I].cycle_count + 1);
    assert_int_equal(post_pc, pre_pc + 3);
}
...
void sty_indexed_test(void **state) {
    ...
    assert_int_equal(read_word_from_memory(USER_SPACE_ROOT + 4 + lower_byte_offset),
                     0x1969);
    assert_int_equal(cycles, opcode_ext_x10_table[OP_STY_I].cycle_count + 1);
    assert_int_equal(post_pc, pre_pc + 4);
}
...
void suba_indexed_test(void **state) {
    ...
    assert_int_equal(e_cpu_context.cc.z, 0);
    assert_int_equal(e_cpu_context.cc.v, 0);
    assert_int_equal(cycles, opcode_table[OP_SUBA_I].cycle_count + 1);
    assert_true(post_pc == pre_pc + 3);
}
...
void subb_indexed_test(void **state) {
    ...
    assert_int_equal(e_cpu_context.cc.z, 0);
    assert_int_equal(e_cpu_context.cc.v, 0);
    assert_int_equal(cycles, opcode_table[OP_SUBB_I].cycle_count + 1);
    assert_true(post_pc == pre_pc + 3);
}
...
void subd_indexed_test(void **state) {
     ...
     assert_int_equal(e_cpu_context.cc.z, 0);
     assert_int_equal(e_cpu_context.cc.v, 0);
     assert_int_equal(cycles, opcode_table[OP_SUBD_I].cycle_count + 1);
     assert_true(post_pc == pre_pc + 3);
}
...
void tst_indexed_test(void **state) {
     ...
     assert_int_equal(cycles, opcode_table[OP_TST_I].cycle_count + 1);
     assert_int_equal(e_cpu_context.cc.n, 0);
     assert_int_equal(e_cpu_context.cc.z, 1);
     assert_int_equal(e_cpu_context.cc.v, 0);
     assert_int_equal(post_pc, pre_pc + 3);
