...
const struct CMUnitTest tests[] = {
    ...
    cmocka_unit_test_setup_teardown(disassemble_instruction_immediate_test, test_setup, test_teardown),
    cmocka_unit_test_setup_teardown(disassemble_instruction_immediate_16_bit_test, test_setup, test_teardown),
    cmocka_unit_test_setup_teardown(disassemble_instruction_immediate_ext_16_bit_test, test_setup, test_teardown),
    cmocka_unit_test_setup_teardown(disassemble_instruction_extended_test, test_setup, test_teardown),
    cmocka_unit_test_setup_teardown(disassemble_instruction_direct_test, test_setup, test_teardown),
    cmocka_unit_test_setup_teardown(disassemble_instruction_indexed_const_off_test, test_setup, test_teardown),
    cmocka_unit_test_setup_teardown(disassemble_instruction_indexed_ext_indirect_test, test_setup, test_teardown),
    cmocka_unit_test_setup_teardown(disassemble_instruction_indexed_const_off_no_off_test, test_setup, test_teardown),
    cmocka_unit_test_setup_teardown(disassemble_instruction_indexed_const_off_16_bit_test, test_setup, test_teardown),
    cmocka_unit_test_setup_teardown(disassemble_instruction_indexed_const_off_8_bit_indirect_test, test_setup, test_teardown),
    cmocka_unit_test_setup_teardown(disassemble_instruction_indexed_acc_test, test_setup, test_teardown),
    cmocka_unit_test_setup_teardown(disassemble_instruction_indexed_acc_indirect_test, test_setup, test_teardown),
    ...
    cmocka_unit_test_setup_teardown(disassemble_instruction_short_branch_test, test_setup, test_teardown),
    cmocka_unit_test_setup_teardown(disassemble_instruction_short_branch_neg_test, test_setup, test_teardown),
    cmocka_unit_test_setup_teardown(disassemble_instruction_long_branch_test, test_setup, test_teardown),
    cmocka_unit_test_setup_teardown(disassemble_instruction_long_branch_neg_test, test_setup, test_teardown),
    cmocka_unit_test_setup_teardown(disassemble_instruction_immediate_push_test, test_setup, test_teardown),
    cmocka_unit_test_setup_teardown(disassemble_instruction_immediate_push_2_test, test_setup, test_teardown),
    cmocka_unit_test_setup_teardown(disassemble_instruction_immediate_push_3_test, test_setup, test_teardown),
    cmocka_unit_test_setup_teardown(disassemble_instruction_immediate_pull_test, test_setup, test_teardown),
    cmocka_unit_test_setup_teardown(disassemble_instruction_immediate_pull_2_test, test_setup, test_teardown),
    cmocka_unit_test_setup_teardown(disassemble_instruction_immediate_tfr_test, test_setup, test_teardown),
    cmocka_unit_test_setup_teardown(disassemble_instruction_immediate_tfr_invalid_test, test_setup, test_teardown),
    cmocka_unit_test_setup_teardown(disassemble_instruction_basic_rom_test, test_setup, test_teardown),
    ...
    cmocka_unit_test_setup_teardown(pia_update_keyboard_test_two_keys, test_setup, test_teardown),
    ...
    cmocka_unit_test_setup_teardown(get_video_starting_address_from_sam_test, test_setup, test_teardown),
    cmocka_unit_test_setup_teardown(get_video_starting_address_from_sam_2_test, test_setup, test_teardown),
    cmocka_unit_test_setup_teardown(get_vdg_mode_1_test, test_setup, test_teardown),
    ...
    cmocka_unit_test_setup_teardown(cmpa_immediate_no_overflow, test_setup, test_teardown),
    cmocka_unit_test_setup_teardown(cmpa_immediate_positive_overflow, test_setup, test_teardown),
    cmocka_unit_test_setup_teardown(cmpa_immediate_negative_overflow, test_setup, test_teardown),
    cmocka_unit_test_setup_teardown(cmpb_immediate_no_overflow, test_setup, test_teardown),
    ...
    cmocka_unit_test_setup_teardown(cmpd_immediate_no_overflow, test_setup, test_teardown),
    cmocka_unit_test_setup_teardown(cmpd_immediate_positive_overflow, test_setup, test_teardown),
    cmocka_unit_test_setup_teardown(cmpd_immediate_negative_overflow, test_setup, test_teardown),
    ...
    cmocka_unit_test_setup_teardown(cmps_immediate_no_overflow, test_setup, test_teardown),
    ...
    cmocka_unit_test_setup_teardown(cmpu_immediate_no_overflow, test_setup, test_teardown),
    ...
    cmocka_unit_test_setup_teardown(cmpx_immediate_no_overflow, test_setup, test_teardown),
    ...
    cmocka_unit_test_setup_teardown(cmpy_immediate_no_overflow, test_setup, test_teardown),
    ...
    cmocka_unit_test_setup_teardown(swi_hook_test, test_setup, test_teardown),
    ...
    cmocka_unit_test_setup_teardown(cmpx_direct_no_overflow_test, test_setup, test_teardown),
    ...
    cmocka_unit_test_setup_teardown(cmpx_extended_no_overflow_test, test_setup, test_teardown),
    ...
    cmocka_unit_test_setup_teardown(cmpx_indexed_no_overflow_test, test_setup, test_teardown),
    ...
    cmocka_unit_test_setup_teardown(program_charset, test_setup, test_teardown)
};
